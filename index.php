...
<div class="page-container123">
	<div class="row">
		<div class="col-sm-6">
			<a href="add.php" id="add_channel">添加渠道号</a>
		</div>
		<div class="col-sm-6" align="right">
			<input id="export_channel" type="button" onclick=setaction("ExportToExcel.php") value="导出Excel"></input>
		</div>
	</div>
	...
	<thead>
		<tr class="first_tr">
			...
			<th>查询条件</th>
			<th><input class = "select_input" type="text" name="channel_number" placeholder="渠道号"></input></th>
			<th><input class = "select_input" type="text" name="channel_name" placeholder="渠道名称"></input></th>
			<th><input class = "select_input" type="text" name="bd" placeholder="BD"></input></th>
			<th>
